...
grid.size = get.grid.size.m2("tract")
...
Zooming in to the non-outlier parts.
...
The following plot shows the average hourly heat emission (W/m2) further averaged across different grids or census tracts
